require(['jquery', 'knockout', 'shared_scripts', 'tipsy', 'cycle_all', 'prettyPhoto'], function ($, ko) {
    ...
    function SinglePortfolioEntryViewModel() {
        var self = this;
        self.DEFAULT_NEWS_PER_PAGE = 6;
        self.newsI18n = getNewsI18nPair();
    }

    var singlePortfolioEntryViewModel = new SinglePortfolioEntryViewModel();

    $(document).ready(function () {
        ko.applyBindings(singlePortfolioEntryViewModel);
    ...
    function getNewsI18nPair() {
        ...
        $.ajax({
            ...
            dataType: 'json',
            url: CMS_ADDRESS + '/rest/singleNewsI18nContent',
