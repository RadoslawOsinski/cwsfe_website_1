require(['jquery', 'knockout', 'shared_scripts', 'tipsy', 'cycle_all', 'prettyPhoto'], function ($, ko) {
    ...
    function appendPortfolioItemPreview(newsI18nPair) {
        ...
        if (images.newsImages != null) {
            ...
            previewOptionsTag += '<a href="../CWSFE_CMS/newsImages/' + images.thumbnailImage.fileName + '" class="lightbox tip2" title="" data-gal="prettyPhoto[gallery_' + newsI18nPair.cmsNews.id + ']"><spring:message code="ViewLargeVersion"/></a>';
            previewOptionsTag += '<div style="display: none;">';
            $.each(images.newsImages, function (index, largeImageInfo) {
                previewOptionsTag += '<a href="newsImages/' + largeImageInfo.fileName + '" class="lightbox tip2" title="" data-gal="prettyPhoto[gallery_' + newsI18nPair.cmsNews.id + ']"><spring:message code="ViewLargeVersion"/></a>';
            });
