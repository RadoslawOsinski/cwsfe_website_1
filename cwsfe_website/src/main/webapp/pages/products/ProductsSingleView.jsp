...
<div class="fixed">
    ...
    <div class="col280 last">
        <ul class="pagination fixed">
            ...
            <li><a href="${portfolioListUrl}"><img
                    src="${pageContext.request.contextPath}/resources-cwsfe/img/portfolio/portfolio-icon.png"
                    height="16" width="16" alt="portfolio list icon"/></a></li>
        </ul>
    </div>
</div>
